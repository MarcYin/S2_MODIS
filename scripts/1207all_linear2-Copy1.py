...
def solve(process):
    ...
    for i,j in process:
        ...
        psolve = optimize.fmin_l_bfgs_b(cost,p,approx_grad=False,factr=10.,iprint=-1,args=(([i,j],)),bounds=bound)
...
pool.close()
pool.join()
parallel_rw_pkl(data, 'bgopb3_modis', 'w')

print 'lol finished bgop b3!!!!!'    
